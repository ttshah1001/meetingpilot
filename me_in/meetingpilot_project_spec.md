...
|---|---|---|
| "Layer you build around the LLM core" (workflow/tools/memory/planning) | Two-call extraction/planning split + SQLite memory + Calendar/Gmail/.ics tools | ✅ multimodal extraction + Calendar + Gmail built, 🔲 .ics pending |
